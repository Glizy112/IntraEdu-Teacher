...
export default class MultipleSelectBtn extends Component {
  constructor(props) {
    super(props);
        ...
        <View
          ...
          {multiplesData.map(interests => (
            <SelectMultipleButton
              ...
              selected={this.state.radioSelectedDatas === interests}
              singleTap={valuesTap =>
                this._singleTapRadioSelectedButton(valuesTap, interests)
              }
            />
          ))}
        </View>
  ...
  _singleTapRadioSelectedButtons(valueTap, interest) {
    // Alert.alert('', valueTap)
    this.setState({
      radioSelectedData: interest,
    });
  }
  _singleTapRadioSelectedButton(valuesTap, interests) {
    // Alert.alert('', valueTap)
    this.setState({
      radioSelectedDatas: interests,
    });
  }
