...
const StudentClient = props => {
  return (
    <View style={styles.container}>
      <TouchableOpacity
        onPress={() => {
          props.navigation.navigate('LeaveStudent');
        }}>
      ...
      <TouchableOpacity
        onPress={() => {
          props.navigation.navigate('StudentLibrary');
        }}>
        <View style={styles.arrow}>
      ...
      <TouchableOpacity
        onPress={() => {
          props.navigation.navigate('PTMLecture');
        }}>
        <View style={styles.arrow}>
      ...
      <TouchableOpacity
        onPress={() => {
          props.navigation.navigate('StudentYoutube');
        }}>
        <View style={styles.arrow}>
      ...
      <TouchableOpacity
        onPress={() => {
          props.navigation.navigate('StudentEvent');
        }}>
        <View style={styles.arrow}>
