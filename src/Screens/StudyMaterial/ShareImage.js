...
const ShareImage = props => {
  ...
  const [getimg, setImg] = useState([
    'notice-1695117399-sms.jpg',
    'notice-1695118910-sms.jpg',
    'notice-1695117399-sms.jpg',
  ]);
  const entries = [
    {
  ...
  const getapiData = async () => {
    ...
    await ApiMethod(Url.listMaterialImage, formData).then(result => {
    ...
    <View style={[container.container]}>
      ...
      <View
        ...
        <View
          ...
          <Text style={[paraGray.largebold, {color: 'black'}]}>Images</Text>
        </View>
      </View>
      <ScrollView
