...
const MPINDisable = props => {
  ...
  const VerifyPIN = async () => {
    ...
    if (value == '') {
      ...
      dispatch(setIsSwitchOn(false)), await AsyncStorage.removeItem('toggle');
  ...
  useFocusEffect(
    useCallback(() => {
      const backAction = () => {
        Alert.alert(
          'Hold on!',
          'MPIN Not Disable Are you sure you want to exit the Page?',
          [
            {
              text: 'Cancel',
              onPress: () => null,
