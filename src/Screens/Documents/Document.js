  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={[paraGray.largebold, {textAlign: 'center'}]}> Documents </Text>
        <Text>Text</Text>
        {/* </View> */}
      </View>
      <View style={{paddingTop: 12, borderBottomWidth: 0.6, borderColor: COLORS.primary}}/>
      
      <View style={{flex: 1, paddingTop: 32, paddingHorizontal: 16, backgroundColor: COLORS.white}}>
        <Text style={[paraGray.largebold, {fontSize: 16}]}> Received Today </Text>
              ...
              >
                ...
                <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                  ...
                  <View style={{paddingLeft: 12}}>
                    ...
                    <Text style={[paraGray.darkpara, {paddingTop: 8, marginLeft: 2}]}> {data.size} </Text>
                  </View>
                </View>
                {/* </View> */}
                <View style={{alignItems: 'flex-end'}}>
                  <AntDesign name="eye" size={22} color={data.stat==="Read" ? COLORS.primary : COLORS.txtGray} />
                  <Text 
                    style={[
                      paraGray.darkpara, 
                      {paddingTop: 4}, 
                      data.stat==="Read" ? {color: COLORS.primary} : {color: COLORS.txtGray}
                    ]}
                  > {data.stat} </Text>
